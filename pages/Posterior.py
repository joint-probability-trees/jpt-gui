        ...
        dbc.Row(
            [
                ...
                dbc.Col(id="q_variable_pos",
                        children=[
                            dcc.Dropdown(id="text_var_pos", options=sorted(c.in_use_tree.varnames), value=sorted(c.in_use_tree.varnames),
                ...
                dbc.Col(id="e_variable_pos",
                        children=[dcc.Dropdown(id={'type': 'dd_e_pos', 'index': 0}, options=sorted(c.in_use_tree.varnames))],
...
def post_router(dd_vals, b_e, op_s, e_var, e_in, q_var, e_op, op_i):
    ...
    return c.update_free_vars_in_div(c.in_use_tree, e_var), e_in, e_op, c.create_prefix_text_query(len(e_var), len(e_var)), \
